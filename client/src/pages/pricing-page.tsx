...
const pricingTiers = [
  {
    ...
    limits: [
      "3 candidates",
      "1 resume scan per candidate",
      "5 job descriptions per month",
      "5 skills tests per month",
      "5 interview sets per month",
  ...
  },
  {
    ...
    limits: [
      "25 candidates",
      "2 resume scans per candidate",
      "25 job descriptions per month",
      "100 skills tests per month",
      "100 interview sets per month",
      "50 PDF exports per month",
      "Bulk upload (5 at a time)",
      "Resume Logic Analyzer",
      "AI Job Description Generator",
      "AI Skills Test Builder",
      "Interview Question Generator",
  ...
  },
  {
    ...
    price: "$59",
    period: "/ month",
    description: "For growing companies hiring regularly. Includes advanced AI and analytics.",
    ...
    limits: [
      ...
      "300 skills tests per month",
      "300 interview sets per month",
      "200 PDF exports per month",
      "Bulk upload (10 at a time)",
  ...
  },
  {
    ...
    price: "$149",
    period: "/ month",
    description: "For agencies and larger teams. Includes team management features.",
    ...
    limits: [
      "200 candidates",
      "2 resume scans per candidate",
      "150 job descriptions per month",
      "1200 skills tests per month",
      "1200 interview sets per month",
      "750 PDF exports per month",
      "Bulk upload (25 at a time)",
      "Advanced AI features",
      "Analytics dashboard",
      "Team management",
      "Resume Logic Analyzer",
  ...
  },
  {
    ...
    price: "Custom",
    period: "",
    description: "Maximum scale with API access and priority support.",
    ...
    limits: [
      "500 candidates",
      "2 resume scans per candidate",
      "3000 job descriptions per month",
      "3000 skills tests per month",
      "3000 interview sets per month",
      "3000 PDF exports per month",
