...
const pricingTiers = [
  {
    ...
    limits: [
      ...
      "All Templates",
      "Advanced plausibility reviews are not included",
    ],
  ...
  },
  {
    ...
    limits: [
      ...
      "Up to 10 automatic advanced reviews per month",
      "15 job descriptions",
      "8 skills tests",
      ...
      "Advanced reviews run automatically when risk indicators are detected",
    ],
  ...
  },
  {
    ...
    limits: [
      ...
      "Up to 40 automatic advanced reviews per month",
      "50 job descriptions",
      "20 skills tests",
      ...
      "All Templates",
      "Unlimited Users per Company",
      "Advanced reviews run automatically only when resume risk is detected",
    ],
  ...
  },
  {
    ...
    limits: [
      ...
      "Up to 200 automatic advanced reviews per month",
      ...
      "Advanced reviews are automatically triggered for high-risk resumes to support compliance",
    ],
