...
// Subscription plan types - 5-tier pricing system
// NOTE: "starter" was renamed to "basic" in the new system
export const PLAN_LIMITS = {
  free: {
    ...
    limits: {
      candidates_max: 3,
      resume_scans_per_candidate: 1,
      job_descriptions_per_month: 5,
      skills_tests_per_month: 5,
      interview_sets_per_month: 5,
      pdf_exports_per_month: 5,
      bulk_upload_max: 0,
    },
    features: {
  ...
  basic: {
    ...
    limits: {
      candidates_max: 25,
      resume_scans_per_candidate: 2,
      job_descriptions_per_month: 25,
      skills_tests_per_month: 100,
      interview_sets_per_month: 100,
  ...
  growth: {
    ...
    limits: {
      candidates_max: 75,
      resume_scans_per_candidate: 2,
      job_descriptions_per_month: 50,
      skills_tests_per_month: 300,
      interview_sets_per_month: 300,
  ...
  pro: {
    ...
    limits: {
      candidates_max: 200,
      resume_scans_per_candidate: 2,
      job_descriptions_per_month: 150,
      skills_tests_per_month: 1200,
      interview_sets_per_month: 1200,
      pdf_exports_per_month: 750,
      bulk_upload_max: 25,
    },
    features: {
      advanced_ai_enabled: true,
  ...
  enterprise: {
    ...
    limits: {
      candidates_max: 500,
      resume_scans_per_candidate: 2,
      job_descriptions_per_month: 3000,
      skills_tests_per_month: 3000,
      interview_sets_per_month: 3000,
      pdf_exports_per_month: 3000,
      bulk_upload_max: 100,
    },
    features: {
      advanced_ai_enabled: true,
    ...
    internal: {
      advanced_ai_monthly_budget: 100,
    },
  },
} as const;
...
export type InternalKey = keyof typeof PLAN_LIMITS.free.internal;
...
export const monthlyUsage = pgTable("monthly_usage", {
  ...
  interviewSetsUsed: integer("interview_sets_used").notNull().default(0),
  pdfExportsUsed: integer("pdf_exports_used").notNull().default(0),
  advancedAiUsed: integer("advanced_ai_used").notNull().default(0),
  createdAt: timestamp("created_at").notNull().default(sql`now()`),
